    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-6 md:p-24 bg-slate-950 text-white">
      <div className="max-w-3xl text-center space-y-8">
        <h1 className="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-cyan-400">
          Casal do Tráfego para Médicos
        </h1>
        <p className="text-xl text-gray-400">
          Estratégias de tráfego pago exclusivas para médicos, clínicas e consultórios.
          Atraia pacientes qualificados e aumente sua autoridade.
        </p>
