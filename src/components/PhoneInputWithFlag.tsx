...
export default function PhoneInputWithFlag({ value, onChange, className }: PhoneInputWithFlagProps) {
  ...
  const handleOnChange = (val: string, data: any, event: any, formattedValue: string) => {
    ...
    if (data && data.format) {
        ...
        const ddiLength = data.dialCode.length;
  ...
  return (
    <div className={`phone-input-container ${className}`}>
      <PhoneInput
        ...
        inputClass="!w-full !h-12 !bg-transparent !text-white !border-white/20 !rounded-md !pl-[48px] focus:!border-purple-500 focus:!ring-purple-500"
        buttonClass="!bg-transparent !border-white/20 !rounded-l-md !hover:bg-white/10"
        dropdownClass="!bg-[#1a103c] !text-white"
        searchClass="!bg-[#1a103c] !text-white"
        specialLabel=""
      ...
      <style jsx global>{`
        ...
        .react-tel-input .form-control::placeholder {
           ...
           opacity: 1 !important; /* Fix for Firefox */
        }
